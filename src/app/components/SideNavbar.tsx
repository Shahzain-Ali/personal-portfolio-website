...
const Sidebar = () => {
  ...
  const menuItems = [
    { name: "Work", link: "#portfolio-sec" },
    { name: "Services", link: "#service-sec" },
    { name: "About", link: "#about-sec" },
    { name: "Contact", link: "#contact-sec" },
  ];
  ...
  return (
    <div className="lg:hidden md:hidden xl:hidden 2xl:hidden sm:block smm:block customsm:block">
      <div
        ref={hamburgerRef}
      ...
      >
        <div
          className={`w-[30px] h-[3px] bg-white rounded-md relative transition-[transform,background-color] duration-500 ease-in-out
            ...
            before:content-[''] before:absolute before:w-[30px] before:h-[3px] before:bg-white before:rounded-md before:transition-transform before:duration-500 before:ease-in-out before:-translate-y-[10px]
            after:content-[''] after:absolute after:w-[30px] after:h-[3px] after:bg-white after:rounded-md after:transition-transform after:duration-500 after:ease-in-out after:translate-y-[10px]
          `}
        />
      </div>
      ...
      <div
        ...
        className={`
          ...
          ${isMenuOpen ? 'sm:w-[180px] md:hidden lg:hidden xl:hidden 2xl:hidden customsm:w-[160px] smm:w-[180px]' : 'w-0'}
        `}
      >
