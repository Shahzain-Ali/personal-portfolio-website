  ...
  return (
    ...
    <div className="h-[100vh] w-[100%] landscape:min-h-screen landscape:bg-gradient-to-br landscape:to-[rgb(17, 17, 17)] landscape:from-[rgb(255, 255, 255)] landscape:w-screen landscape:h-auto " id="home-sec box-border">
      ...
      <main className="md:w-[100%] h-[78vh] customsm:w-[100%] mx-auto md:flex sm:w-[100%] customsm:h-[480px]  gap-16 md:gap-[4px] sm:gap-[8px] sm:justify-between sm:ml-0  customsm:text-center custom-[gap-14] sm:flex ">
        ...
        <p className="text-gray-400 text-[0.95rem] sm:text-[0.85rem] customsm:text-[0.8rem] mt-2 leading-relaxed max-w-[500px]">
        ...
        <section className="grid grid-cols-4 gap-x-6 gap-y-3 mt-4 customsm:mx-auto customsm:w-auto customsm:gap-x-4 customsm:gap-y-2 customsm:pt-3 smm:mx-auto md:mx-0 shadow-secondary rounded-md w-96 md:w-[480px] p-4 border">
          ...
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-gray-300 text-[10px] md:text-xs whitespace-nowrap">Python</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-gray-300 text-[10px] md:text-xs whitespace-nowrap">OpenAI</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-gray-300 text-[10px] md:text-xs whitespace-nowrap">MCP</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <svg viewBox="0 0 24 24" width="28" height="28" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-gray-300 text-[10px] md:text-xs whitespace-nowrap">Streamlit</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-gray-300 text-[10px] md:text-xs whitespace-nowrap">FastAPI</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-gray-300 text-[10px] md:text-xs whitespace-nowrap">n8n</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-gray-300 text-[10px] md:text-xs whitespace-nowrap">Next.js</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <svg viewBox="0 0 24 24" width="28" height="28" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-gray-300 text-[10px] md:text-xs whitespace-nowrap">Docker</span>
          </div>
        </section>
      ...
      */}
      ...
      {/* PERSONAL IMAGE - DESKTOP */}
      <section id="section-2" className="w-[60%] md:w-[60%] lg:w-[65%] md:mr-0 customsm:hidden smm:hidden md:block sm:w-[40%] sm:mr-0 mx-auto flex items-center justify-center self-center">
        <div className="relative flex items-center justify-center">
          <div className="absolute w-[80%] h-[85%] rounded-full bg-gray-800/60 blur-sm top-[20%]"></div>
          <Image
            src="/images/shahzain-no-bg.png"
            alt="Shahzain Ali — AI Automation Developer"
            width={1300}
            height={1200}
            className="relative z-10 object-contain drop-shadow-2xl lg:scale-150"
            priority
          />
        </div>
      </section>

      {/* PERSONAL IMAGE - MOBILE */}
      <section className="w-full md:hidden smm:block customsm:block mt-6 flex items-center justify-center">
